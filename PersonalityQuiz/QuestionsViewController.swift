...
class QuestionsViewController: UIViewController {
    ...
    @IBOutlet weak var submitButtonRanged: UIButton!
    ...
    @IBAction func singleAnswerButotnTapped(_ sender: UIButton) {
    ...
    func updateSingleStack(using answers: [Answer]) {
        submitButtonRanged.isHidden = true
    ...
    func updateRangedStack(using answers: [Answer]) {
        submitButtonRanged.isHidden = false
        submitAnswerButton.isHidden = true
